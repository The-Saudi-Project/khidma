  ...
  return (
    <div className="min-h-screen bg-white flex flex-row-reverse">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#081225] relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#C5A059]/10 rounded-full blur-[100px] pointer-events-none translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#C5A059]/5 rounded-full blur-[120px] pointer-events-none -translate-x-1/3 translate-y-1/3" />
        ...
        <div className="relative z-10 max-w-md mt-20">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 mb-6">
            <Zap size={14} className="text-[#C5A059] fill-[#C5A059]" />
            <span className="text-xs font-bold text-white uppercase tracking-wider">Fast, Secure, Reliable</span>
          </div>
          <h1 className="text-5xl font-extrabold text-white leading-[1.1] tracking-tight mb-6">
            Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C5A059] to-[#E2C78D]">Khidma</span> Network.
          </h1>
        ...
        <div className="w-full max-w-md mt-12 lg:mt-0">
          ...
          <div className="flex p-1 bg-slate-100 rounded-xl mb-8">
            <button
              ...
              className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${
                form.role === 'customer' 
                  ? 'bg-white text-slate-900 shadow-[0_2px_8px_rgba(8,18,37,0.08)]' 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input 
                className={`w-full px-4 py-3 rounded-xl border bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:ring-2 focus:ring-[#C5A059] focus:border-[#C5A059] transition-all font-medium placeholder:font-normal ${errors.name ? 'border-red-400 focus:ring-red-400 focus:border-red-400' : ''}`}
            ...
            <div>
              ...
              <input type="email" 
                className={`w-full px-4 py-3 rounded-xl border bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:ring-2 focus:ring-[#C5A059] focus:border-[#C5A059] transition-all font-medium placeholder:font-normal ${errors.email ? 'border-red-400 focus:ring-red-400 focus:border-red-400' : ''}`}
            ...
            <div>
              ...
              <input type="tel" 
                className="w-full px-4 py-3 rounded-xl border bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:ring-2 focus:ring-[#C5A059] focus:border-[#C5A059] transition-all font-medium placeholder:font-normal"
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'}
                  className={`w-full px-4 py-3 rounded-xl border bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:ring-2 focus:ring-[#C5A059] focus:border-[#C5A059] transition-all font-medium placeholder:font-normal pr-12 ${errors.password ? 'border-red-400 focus:ring-red-400 focus:border-red-400' : ''}`}
            ...
            <button type="submit" disabled={loading} className="w-full bg-[#081225] text-white py-3.5 rounded-xl font-bold text-sm hover:bg-[#112240] active:bg-[#060d1a] transition-all flex justify-center items-center gap-2 mt-6 shadow-[0_4px_14px_0_rgba(8,18,37,0.15)] disabled:opacity-70 disabled:cursor-not-allowed">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <Link to="/login" className="text-[#C5A059] font-bold hover:text-[#b08e4d] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
